...
export const setStatusSessioncour = (id, sessioncourStatus) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/updatsessioncourstatus/${id}`, sessioncourStatus, config)
...
export const newSessioncour = (a) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`/api/v1/sessioncour/new`, a, config)
...
export const getSessioncoursAvailableStudent = () => async (dispatch) => {
    try {
        ...
        let link = `/api/v1/availablesessioncours`
